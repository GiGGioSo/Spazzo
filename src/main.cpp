...
glm::mat4 text_projection = glm::ortho(0.0f, (float)WIDTH, 0.0f, (float)HEIGTH, 0.0f, 1.0f);
...
int main() {
    ...
    // text shader
    Shader textshader("res/shaders/text.vs", "res/shaders/text.fs");
    textshader.use();
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        renderText(textshader, "CIAOOOOO", 0.0f, 0.0f, .5f, glm::vec3(0.1f, 0.1f, 0.1f));
